...
const checkLogin = () => new Promise((resolve, reject) => {
  (window as any).FB.getLoginStatus((response) => handleLoginStatus(response)
    .then(resolve, reject));
});
...
const login = () => new Promise((resolve, reject) => {
  (window as any).FB.login((response) => handleLoginStatus(response)
...
const logout = () => new Promise((resolve) => {
  (window as any).FB.logout(resolve);
});
